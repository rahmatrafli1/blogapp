<x-layout>
    ...
    <ul>
        <li class="flex flex-row py-2 gap-2">
            ...
            <a href="mailto:rahmatrafli1@gmail.com" target="_blank" class="text-blue-500">rahmatrafli1@gmail.com</a>
        </li>
        <li class="flex flex-row py-2 gap-2">
            ...
            <a href="https://www.facebook.com/rahmat.rafli.7" target="_blank" class="text-blue-500">Facebook
                Profile</a>
        </li>
        <li class="flex flex-row py-2 gap-2">
